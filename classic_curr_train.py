...
To run: 
python classic_curr_train.py --layout classic --episodes 25 --epochs 10 --batch_size 64
"""
...
def collect_tabular_dataset(layout: str = "classic", episodes: int = 500, max_steps=1000):
