...
To run: 
python spiral_curr_train.py --episodes 25 --epochs 10 --batch_size 64
"""
...
def collect_tabular_dataset(layout: str = "spiral_harder", episodes: int = 500, max_steps=1000):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--layout", type=str, default="spiral_harder", help="Pacman layout to train on")
