#!/usr/bin/env python
"""
train.py – train a separate DQN for board layout ("spiral", "spiral_harder").
trains on spiral_harder only because it is more challenging.
Saved weight files:
...
def train_layout(layout: str = "spiral_harder", episodes: int = NUM_EPISODES) -> Path:
